            ...
            <div class="row"><!--location content -->
                <section>
                    <div class="container">
                        ...
                        <div class="modal fade" id="ananasbar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"><!--location modal content-->
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header"><!--modal header-->
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><!--close button on top-->
                                        <h4 class="modal-title" id="myModalLabel">Ananas Bar & restaurant</h4><!--modal title-->
                                    </div>
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            <div class="col-md-6"><!--image holder with 6 grid column-->
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                <h5>THE ROCKS</h5><!--content title-->
                                                <p>
                                                The Rocks is home to some of Sydney’s most intriguing historical stories and
                                                
                                                </p>
                                            </div> 
                                            <div class="modaltext2 col-md-12">
                                                <p>
                                                And our landmark venue, The Argyle, has a unique, rich history all of its own.
                                                ...
                                                and a daily plateau fruits de mer.
                                                </p>
                                            </div>
                                        </div><!--modal body-->
                                    </div>
                        ...
                        <div class="subcontent col-md-8"><!--location non modal content -->
                            <h1 class="title">Ananas Bar & restaurant</h1><!--location title-->
                            <p class="location">The Rocks Street</p><!--location secondary content-->
                            <p class="definition">
                            Ananas Bar & restaurant is the Hyderabad's Sophisticate’s adult playground.
                ...
                <section>
                    <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                ...
                                                <p>
                                                There’s no question that The Rocks is home to some of Hyderabad’s most intriguing historical stories. And
                        ...
                        <div class="subcontent col-md-8">
                            ...
                            <p class="definition">There’s no question that The Rocks is home to some of Hyderabad’s most intriguing historical stories.
            ...
            <div class="row"><!--location content -->
                <section>
                    <div class="container">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                <h5>THE BEST OF BAVARIA AT Hyderabad</h5>
                                                <p>
                                                ...
                                                located in the heart of Hyderabad’s bustling South Wharf.
                                                </p>
                                            </div> 
                                            <div class="modaltext2 col-md-12">
                                                <p>
                                                ...
                                                prefect destination for events. 
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="subcontent col-md-8">
                            <h1 class="title">Munich's</h1>
                            <p class="location">Jubli Hills</p>
