                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--event content holder with 6 grid column-->
                            <h1 class="title">Madhu's 21st</h1><!--event content title-->
                            <p class="location"><!--event content location-->
                            Sri Private Dining Room, Jubli hills
                            </p>
                            <p class="definition"><!--event content definition-->
                                We provide a private dining room for your special day.
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--event content holder with 6 grid column-->
                            ...
                            <p class="location"><!--event content location-->
                            Ananas Bar & restaurant, The Rocks Banjara Hills
                            </p>
                            <p class="definition"><!--event content definition-->
                                We provide tips to dress to impress.
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--event content holder with 6 grid column-->
                            ...
                            <p class="location"><!--event content location-->
                                LB nagar 2nd floor,Hyderabad.
                            </p>
                            <p class="definition"><!--event content definition-->
                                We make your Anniversary a memorable one.
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--event content holder with 6 grid column-->
                            ...
                            <p class="location"><!--event content location-->
                            UrbanXchange Private Dining Room, Kukatpally.
                            </p>
                            <p class="definition"><!--event content definition-->
                                Let's talk together about your career and make it succsessful
